...
<div class="panel">
	...
	<form method="POST" action="{{ route('degrees.store') }}">
		...
		<div style="margin-bottom:12px;">
			...
			<input id="degree_title" name="degree_title" type="text" value="{{ old('degree_title') }}" required style="width:100%;padding:10px;border:1px solid #cbd5e1;border-radius:8px;">
		</div>

		<button type="submit" style="background:#0f172a;color:#fff;padding:10px 16px;border:none;border-radius:8px;font-weight:700;cursor:pointer;">Save Degree</button>
